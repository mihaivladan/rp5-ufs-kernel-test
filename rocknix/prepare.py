...
def apply_patches(repo, source, fix):
    ...
    minimal_dts = Path(__file__).resolve().parent / "sm8250-retroidpocket-rp5-minsleep3.dts"
    ...
    for name in ("sm8250-retroidpocket-rp5", "sm8250-retroidpocket-rp5-minsleep3"):
