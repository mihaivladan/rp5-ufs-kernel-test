...
The build emits the reusable full-audio/product candidate.  The controlled
first test derives its Device Tree directly from the already-proven Phase
6W/6Y binary, changing only the Android firmware name and remoteproc
dependency; this avoids treating a regenerated but merely similar tree as the
same baseline.
